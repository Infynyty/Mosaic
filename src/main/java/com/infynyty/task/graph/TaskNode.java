 ...
 * {@link com.infynyty.task.events.TaskActionEvent event} occurs, the edge resolver of the class should respond accordingly.
 * A node will be considered a terminal node, if {@link #isTerminalNode()} returns {@code false}, resulting in a
 * {@link com.infynyty.task.tasks.TaskState#COMPLETED completed task}.
 */
public interface TaskNode {
    /**
     * Returns whether a node is terminal, i.e. changing state to this node triggers the state of a task to switch to
     * {@link com.infynyty.task.tasks.TaskState#COMPLETED}.
     *
