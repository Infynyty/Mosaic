...
/**
 * Each object of this type represents a task. A Task consists of exactly one {@link TaskStartNode start node} and
 * optionally any number of {@link TaskNode normal nodes}, which can be thought of as a directed graph.
...
public abstract class Task<R extends RunningTask<?>> {
    ...
    /**
     * Creates a new task. Any task is required to have exactly one {@link TaskStartNode start node}.
     *
     * @param startNode The single entry point of the task.
     */
    public Task(@NotNull final TaskStartNode startNode) {
     ...
     */
    protected abstract void initialize(@NotNull final TaskParticipant participant) throws TaskAlreadyRunning;
     ...
     * @param <E> The type of the {@link TaskParticipant participant}.
     ...
     */
    protected abstract <E extends TaskParticipant> RunningTask<E> getTaskProgress(@NotNull final E participant) throws TaskNotRunning;
